...
const AddDelivery = () => {
    ...
    const [items, setItems] = useState([
        { inventory_id: '', quantity_received: '', unit_cost: '', total_cost: 0 }
    ]);
    ...
    const updateRow = (idx, field, value) => {
        setItems(prev => {
            ...
            // Auto-fill unit cost from inventory if picking an item and cost is empty
        ...
        <div className="space-y-6 max-w-5xl">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-slate-400 text-sm">Record received items and update inventory automatically.</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-slate-900 rounded-2xl border border-slate-800 p-6 shadow-xl">
                    <div className="flex items-center gap-3 mb-5">
                        <div className="h-9 w-9 bg-blue-600/20 rounded-xl flex items-center justify-center">
                ...
                {/* Status notice */}
                {status === 'received' && (
                    <div className="flex items-start gap-3 px-4 py-3 bg-emerald-500/10 border border-emerald-500/30 rounded-xl">
                        <CheckCircleIcon className="h-5 w-5 text-emerald-400 shrink-0 mt-0.5" />
                        <p className="text-emerald-300 text-sm">
                            <strong>Stock will be updated immediately</strong> — inventory quantities will be incremented for each item on save.
                        </p>
                    </div>
                )}
                {status === 'draft' && (
                    <div className="flex items-start gap-3 px-4 py-3 bg-amber-500/10 border border-amber-500/30 rounded-xl">
                        <p className="text-amber-300 text-sm">
                            <strong>Draft mode</strong> — this delivery will be saved but stock will NOT be updated yet.
                        </p>
                    </div>
                )}
                ...
                <div className="flex gap-3 justify-end">
                    ...
                    <button type="submit" disabled={submitting}
                        className="flex items-center gap-2 px-6 py-2.5 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20 text-sm font-semibold disabled:opacity-50">
                        {submitting ? (
